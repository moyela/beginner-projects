...
fn main() 
    {   
        ...
        //ch.to.digit(10) converts our input from character data type to integer
...
fn modular_inverse(a, m)
    {
        ...
        //if everything is somehow all successful at the end of the day, we print the modular multiplicative inverse as given below
